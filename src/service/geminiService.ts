...
export async function generateFlashcards(text: string): Promise<Flashcard[]> {
    ...
    try{
        ...
        const prompt = `Based on the following test, generate 8-12 flashcards for active recall learning. Format your response as a JSON array with objects containing "question" and "answer" fields. Make the questions challengin but fair, and provide clear and concise answers.
        ...
        Text content: ${text.substring(0, 1000)}

        Response with only the JSON array, no additional text or explanation.
        `;
